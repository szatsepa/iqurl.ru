...
function attachS(cod) {
    ...
    document.write ('<form action="index.php?act=attachsoundpres" method="post"><input type="hidden" name="id" value="'+id+'"/><input name="row" type="hidden" value="'+row+'"/><input name="name_id" type="hidden" value="'+name_id+'"/></form>');
